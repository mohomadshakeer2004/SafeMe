...
class ChangePasswordAlert {
  bool isCodeSentBool = false;
  static final ChangePasswordAlert _changePasswordAlert =
  ChangePasswordAlert._internal();

  factory ChangePasswordAlert() {
    return _changePasswordAlert;
  }
